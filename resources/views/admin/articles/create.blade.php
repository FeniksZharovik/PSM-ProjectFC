...
@section('content')
<form id="articleForm" method="POST" action="{{ route('admin.articles.store') }}" enctype="multipart/form-data" class="space-y-4 sm:space-y-5" novalidate>
    @csrf
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-5">
            ...
            <div class="bg-white rounded-xl sm:rounded-2xl border border-slate-200 p-4 sm:p-5 space-y-3 sm:space-y-4">
                ...
                <div>
                    ...
                    <textarea name="excerpt" rows="2" maxlength="300"
                        ...
                        class="w-full rounded-xl border border-slate-300 px-3 sm:px-4 py-2 sm:py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500 resize-none">{{ old('excerpt') }}</textarea>
                </div>
            </div>
        ...
        <div class="space-y-4 sm:space-y-5">
            ...
            <div class="bg-white rounded-xl sm:rounded-2xl border border-slate-200 p-4 sm:p-5">
                <h2 class="font-semibold text-slate-800 text-xs sm:text-sm mb-3">Thumbnail <span class="text-red-500">*</span></h2>
    ...
    document.getElementById('articleForm').addEventListener('submit', function(e) {
        ...
        const checks = [
            ...
            },
            {
                ...
                test: () => document.getElementById('thumbnailInput').files.length > 0,
